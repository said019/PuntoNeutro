    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        {dynamicPolicy ? (
          ...
          <p>
            Usted tiene derecho a Acceder, Rectificar, Cancelar u Oponerse (derechos ARCO) al tratamiento de sus datos personales. Para ejercer estos derechos, envíe una solicitud al correo electrónico <strong className="text-primary">contacto@puntoneutro.mx</strong> indicando:
          </p>
          <ul className="list-disc pl-6 space-y-2">
