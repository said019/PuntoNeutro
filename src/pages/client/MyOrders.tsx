      ...
      <ClientLayout>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-bold text-[#2d2d2d]">Mis órdenes</h1>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12 space-y-3">
              <ShoppingBag size={40} className="mx-auto text-[#94867a]/30" />
              <p className="text-sm text-[#5a524a]">No tienes órdenes aún</p>
            ...
            <div className="space-y-3">
              {orders.map((o) => {
                ...
                return (
                  <div
                    key={o.id}
                    className="rounded-xl border border-[#e8e9e3] bg-white p-4 hover:shadow-sm transition-shadow"
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1 min-w-0">
                        ...
                        <p className="text-[11px] text-[#94867a]">
